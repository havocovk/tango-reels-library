// www/icons.js
// Lucide-uyumlu SVG ikon yardımcısı
// Tokyo Cyber-Synthwave renk paleti:
//   Cyan   #00f0ff  |  Pink   #ff007f  |  Purple #c026d3
//   Green  #4ade80  |  Amber  #f59e0b  |  Red    #ef4444
//   Muted  #64748b  |  White  #f1f5f9
...
const ICON_PATHS = {
    ...
    'dumbbell':        `<path d="M17.596 12.768a2 2 0 1 0 2.829-2.829l-1.768-1.767a2 2 0 0 0 2.828-2.829l-2.828-2.828a2 2 0 0 0-2.829 2.828l-1.767-1.768a2 2 0 1 0-2.829 2.829zM2.5 21.5l1.4-1.4M20.1 3.9l1.4-1.4M5.343 21.485a2 2 0 1 0 2.829-2.828l1.767 1.768a2 2 0 1 0 2.829-2.829l-6.364-6.364a2 2 0 1 0-2.829 2.829l1.768 1.767a2 2 0 0 0-2.828 2.829zM9.6 14.4l4.8-4.8"/>`,
    ...
    'footprints':      `<path d="M4 16v-2.5C4 10 7 7 10.5 7S17 10 17 13.5V16"/><path d="M4 16a2 2 0 0 1 2-2h.5a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2z"/><path d="M15 16a2 2 0 0 1 2-2h.5a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2H17a2 2 0 0 1-2-2z"/>`,
...
export function icon(name, { size = 16, color = 'currentColor', strokeWidth = 2, cls = '', fill = 'none' } = {}) {
    const paths = ICON_PATHS[name];
    if (!paths) {
        console.warn(`icons.js: "${name}" ikonu bulunamadı`);
        return '';
    }
    const classes = `lucide-icon${cls ? ' ' + cls : ''}`;
    return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" fill="${fill}" stroke="${color}" stroke-width="${strokeWidth}" stroke-linecap="round" stroke-linejoin="round" class="${classes}" aria-hidden="true" style="display:inline-block;vertical-align:middle;flex-shrink:0;">${paths}</svg>`;
}