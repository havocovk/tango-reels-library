...
export const en = {
    ...
    menuPracticeList: "Practice List",
    ...
    emptyFav: "Your favorites list is empty yet. <br> Click the star icon on the cards to save your favorite combinations here!",
    emptyPracticeList: "Your practice list is empty yet. <br> Click the dumbbell icon on the cards to gather this week's practices here!",
    ...
    dropText: "Click here and paste screenshot via Ctrl + V",
    ...
    allDates: "All Dates",
    closeBtn: "Close",
    btnClearFavorites: "Clear All Favorites",
    btnClearPracticeList: "Clear Practice List",
    confirmClearFavs: "Are you sure you want to remove all stars from your favorites?",
    confirmClearPracticeList: "Are you sure you want to remove all videos from your practice list?",
    ...
    favoritesCountLabel: "Number of Videos in Favorites:",
    practiceListCountLabel: "Number of Videos in Practice List:",
    addNote: "Add note",
    editNote: "Edit note",
