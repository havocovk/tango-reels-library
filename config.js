...
export const translations = {
    tr: {
        ...
        error: "❌ Veritabanı bağlantısı başarısız oldu. Lütfen internetinizi veya bağlantı anahtarlarını kontrol edin.",
        role: "🎬 Rol",
        location: "📍 Ortam",
        watch: "🔗 Videoyu İzle →",
        langBtn: "🇬🇧 EN",
        ...
        uploadError: "❌ Resim Supabase Storage'a yüklenemedi! Kova ayarlarını kontrol edin.",
        allRoles: "Tüm Roller",
        leader: "Lider",
        follower: "Takipçi",
        both: "İkisi de",
    ...
    en: {
        ...
        error: "❌ Database connection failed. Please check your connection keys.",
        role: "🎬 Role",
        location: "📍 Storage",
        watch: "🔗 Watch Video →",
        langBtn: "🇹🇷 TR",
